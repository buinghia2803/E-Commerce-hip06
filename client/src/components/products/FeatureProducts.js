  ...
  return (
    <div className='w-full'>
      ...
      <div className='flex justify-between'>
        <img className='w-[49%] object-contain' src="https://digital-world-2.myshopify.com/cdn/shop/files/banner1-bottom-home2_b96bc752-67d4-45a5-ac32-49dc691b1958_600x.jpg?v=1613166661" alt="" />
